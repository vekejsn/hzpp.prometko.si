            ...
            vehicles.forEach(async vehicle => {
                ...
                marker.getElement().addEventListener('click', async () => {
                    while (true) {
                        ...
                        const $scheduleTable = mz_makeScheduleTable(marker);

                        showSidebar({
                            content: /*html*/`
                            <div class="sidebar-inner" id="sidebar-mk-${marker.data.train_data.train_number.replaceAll(' ','')}">
...
function mz_makeScheduleTable(marker) {
